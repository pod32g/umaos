...
check_contains "$AIROOTFS/home/arch/.config/autostart/umaos-theme-first-login.desktop" 'Exec=/usr/local/bin/umao-apply-theme --once' "Live-user autostart reapplies theme once"
